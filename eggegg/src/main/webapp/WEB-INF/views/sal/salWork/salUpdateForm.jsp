	...
	<form:form commandName="payInfo" id="form" method="post">
		<table>
			...
			<tr>
				...
				<c:if test="${vo.piType eq '상여'}">
					<td>
						<select name="piType">
							<option value="급여">급여</option>
							<option value="상여" selected>상여</option> 
						</select>
						<form:errors path="piType" element="label" id="piType-error" cssClass="error" for="piType"/>
					</td>
				</c:if>
			...
			<tr id="hidden">
				<td>
				<span>지급액</span><input type="text" id="bonus" name="piBonusamount" onkeyup="inputNumberFormat(this)" value='<fmt:formatNumber value="${vo.piBonusamount}"/>'>
			...
			<tr>
				<th>대상기간</th>
				<td>
				<input type="date" name="piTargetdo" value="${ vo.piTargetdo }">
				<form:errors path="piTargetdo" element="label" id="piTargetdo-error" cssClass="error" for="piTargetdo" />
				~
				<input type="date" name="piTargetdt" value="${ vo.piTargetdt }">
			...
			<tr>
				<th>지급일</th>
				<td>
					<input type="date" name="piPayday" value="${vo.piPayday }">
			...
			<tr>
				<th>급여대장명칭</th>
				<td>
					<input type ="text" name="piNm" value="${vo.piNm }">
