...
<body>
<div id="errorImg">
<img alt="400error" src="${cPath }/resources/errorImages/400error.png">
</div>
<h3><spring:message code="sorry"/>&nbsp;<spring:message code="badRequest"/></h3><br>
<span class="notFound1"><spring:message code="badRequestPage"/></span><br>
