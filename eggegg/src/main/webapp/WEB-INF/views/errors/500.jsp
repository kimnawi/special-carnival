...
<body>
<div id="errorImg">
<img alt="500error" src="${cPath }/resources/errorImages/500error.png">
</div>
<h3><spring:message code="sorry"/>&nbsp;<spring:message code="serverError"/></h3><br>
<span class="notFound1"><spring:message code="serverErrorPage"/></span><br>
