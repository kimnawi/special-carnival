...
<body>
<div id="errorImg">
<img alt="404error" src="${cPath }/resources/errorImages/404image.png">
</div>
<h3><spring:message code="sorry"/>&nbsp;<spring:message code="notFoundPage"/></h3><br>
<span class="notFound1"><spring:message code="notExistPage"/></span><br>
